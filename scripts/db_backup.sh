...
# Configuration
PROJECT_DIR="/Users/wohozo/Documents/astroelevent"
BACKUP_DIR="$PROJECT_DIR/backups"
TIMESTAMP=$(date +"%Y-%m-%d_%H-%M-%S")
BACKUP_NAME="astroeleven_db_$TIMESTAMP"
...
if [ $? -eq 0 ]; then
    ...
    if command -v rclone &> /dev/null; then
        ...
        # Change 'gdrive:astroeleven_backups' to your rclone remote name and folder
        rclone sync "$BACKUP_DIR" gdrive:astroeleven_backups
    else
