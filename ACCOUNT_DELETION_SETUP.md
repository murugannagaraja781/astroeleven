...
**URL**: `https://astroeleven.com/delete-account.html`
...
**URL**: `https://astroeleven.com/admin/deletion-requests.html`
...
### For Users:
1. Visit `https://astroeleven.com/delete-account.html`
...
### For Admins:
1. Visit `https://astroeleven.com/admin/deletion-requests.html`
...
```bash
curl -X POST https://astroeleven.com/api/delete-account-request \
